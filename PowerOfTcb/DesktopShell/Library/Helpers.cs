...
namespace DesktopShell.Library
{
    ...
    {
        public static bool EnableSeAssignPrimaryTokenPrivilege()
        {
            NTSTATUS ntstatus;
            int nDosErrorCode;
            ...
            do
            {
                ...
                for (var idx = 0; idx < nPrivilegeCount; idx++)
                {
                    ...
                    if (priv == Win32Consts.SE_ASSIGNPRIMARYTOKEN_PRIVILEGE.ToInt64())
                    {
                        bPresent = true;
                ...
                if (bPresent && !bEnabled)
                {
                    ...
                    info.Privileges[0].Luid = Win32Consts.SE_ASSIGNPRIMARYTOKEN_PRIVILEGE;
