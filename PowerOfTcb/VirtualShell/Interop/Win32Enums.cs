...
namespace VirtualShell.Interop
{
    ...
    {
        Add, // LSA_SID_NAME_MAPPING_OPERATION_ADD_INPUT
        Remove, // LSA_SID_NAME_MAPPING_OPERATION_REMOVE_INPUT
        AddMultiple // LSA_SID_NAME_MAPPING_OPERATION_ADD_MULTIPLE_INPUT
    }
