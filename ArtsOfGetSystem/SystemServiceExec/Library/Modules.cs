...
namespace SystemServiceExec.Library
{
    ...
    internal class Modules
    {
        ...
        public static bool GetSystemServiceProcess(
            string username,
            string domain,
            string password,
            string command,
            int nDelayMilliseconds)
        {
            ...
            Console.WriteLine("[*] Trying to create a service process.");
            Console.WriteLine("    [*] Service Name: {0}", serviceName);
            Console.WriteLine("    [*] BinPath     : {0}", command);
            bSuccess = Utilities.CreateProcessAsSystemService(
                serviceName,
                serviceName,
                command,
                nDelayMilliseconds);
            ...
            {
                Console.WriteLine("[-] Failed to create a system service process (Error = 0x{0}).",
                    Marshal.GetLastWin32Error().ToString("X8"));
            }
